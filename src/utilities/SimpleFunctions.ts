...
export const FederalChange = (settlements: SettlementInterface[]) => {
...
export const GetFederalGoodsStored = (settlements: SettlementInterface[],months: number): goodsdist => {
    const store_per_turn = FederalChange(settlements)

...
export default function PlaceOrder(
    ...
    return(
        <div className="flex flex-column gap-1">
            Capacity Used: {capUsed} / {merchantCapacity}
            <OrderRow 
            ...
            />
        <Button 
            disabled={maxCost < totalGoods(multiplyGoods(order,prices))} 
            severity={maxCost < totalGoods(multiplyGoods(order,prices)) ? 'danger' : 'success' }
        ...
        > 
                <div className="flex flex-row gap-1">
                    Purchase for
                    <MoneyIconTT/>
                    {totalGoods(multiplyGoods(order,prices))}
                </div>
            </Button>
        </div>

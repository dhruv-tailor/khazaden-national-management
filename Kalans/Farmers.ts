...
export class Farmers extends Kalan {
    ...
    update_loyalty(goods: Map<string, Good>,mazar: Archivists) {
        ...
        if(mazar.bureaucratic_component.focus === BureaucraticFocus.Zaram){
    ...
    update_efficiency(goods: Map<string, Good>,uzbaden: Rulers) {
        let beaurcracy_bonus = 0
        if(uzbaden.bureaucratic_component.focus === BureaucraticFocus.Zaram){
    ...
    update_development_growth(baraz: Merchants): void {
        ...
        if (baraz.bureaucratic_component.focus === BureaucraticFocus.Zaram) {
    ...
    update_population_growth(zigil: Clerics) {
        ...
        if (zigil.bureaucratic_component.focus === BureaucraticFocus.Zaram) {
